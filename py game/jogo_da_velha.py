...
fonte_mensagem = pygame.font.SysFont("Comic Sans MS", 150) # Tipo de fonte e tamanho 

# Mensagens que vai aparecer: "Game Over!" e "Velha!"
...
fonte_quadrinhos = pygame.font.SysFont("Comic Sans MS", 80) #importando a fonte e definindo o tamanho dela
...
# Lógica para preencher os quadrantes com X ou O
def faz_jogada():
...
# Verifica se os qudrantes estão preenchidos para determinar um vencedor ou se deu velha
def check_vencedor():
    status = False
    if q1 == q2 == q3 != '': # Se os 3 primeiros quadrantes estiverem preenchidos e não estiverem vazios:
        status = True
        pygame.draw.line(screen, "Red",(0, 100), (600, 100), 7) # aparece uma linha vermelha na horizontal desses 3 primeiros quadrantes
        screen.blit(mensagem1, (100, 50)) # a mensagem "Game" aparecerá na tela
        screen.blit(mensagem2, (100, 250))  # a mensagem "Over!" aparecerá na tela

        #  Acontece a mesma coisa acima com os outros quadrantes seguindo a lógica abaixo:
    elif q4 == q5 == q6 != '':
        status = True
        pygame.draw.line(screen, "Red",(0, 300), (600, 300), 7)
        screen.blit(mensagem1, (100, 50)) 
        screen.blit(mensagem2, (100, 250)) 
    ...
    if not status:
        ...
        # Se todos os quadrantes forem diferente de vazio e não se encaixar nas condições (elif) anteriores:
        if q1 != '' and q2 != '' and q3 != '' and q4 != '' and q5 != '' and q6 != '' and q7 != '' and q8 != '' and q9 != '':
            screen.blit(velha, (80, 150))   # Aparece a mensagem "Velha!"
